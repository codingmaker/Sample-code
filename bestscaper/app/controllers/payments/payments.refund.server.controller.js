...
exports.refundPayment =function(req,res,next){
    ...
    async.waterfall([
        ...
        function(done){
            updateCompany.payment.coupon = false;
            updateCompany.payment.plan = 'Basic';
            updateCompany.payment.pay = [];
            updateCompany.payment.from = null;
            updateCompany.payment.emailed = false;
            updateCompany.payment.to = null;
            updateCompany.coveredAreas.splice(2);
